...
public class LoadingComponent : MonoBehaviour
{
    ...
    private void LoadNextLevel()
    {
        ...
        asy = Application.LoadLevelAsync("Scene_0");
    }
        ...
        if (asy != null)
        {
            if (!asy.isDone)
            {
				...
				{   GUI.color=Color.black;
					...
					GUI.Label(new Rect(Screen.width/2+2, loadingBarPosition.y - 20+2, 50, 50), loadingText, textStyle);
                ...
                {
					GUI.color=Color.black;
                    GUI.Label(new Rect(Screen.width/2, (loadingBarPosition.y*Screen.height) - 50, 50, 50),loadingText, textStyle);
					GUI.color=Color.white;
					GUI.Label(new Rect(Screen.width/2+2, (loadingBarPosition.y*Screen.height) - 50+2, 50, 50),loadingText, textStyle);
                    if (showProgressPercentage)
                    {
                        GUI.Box(
            ...
            else
            {
				...
				{GUI.color=Color.black;
					...
					GUI.color=Color.white;
					GUI.Label(new Rect(Screen.width/2+2, loadingBarPosition.y - 50+2, 50, 50), loadingText, textStyle);
                    if (showProgressPercentage)
                    {
                        GUI.Box(
                         new Rect(loadingBarPosition.x, loadingBarPosition.y,
