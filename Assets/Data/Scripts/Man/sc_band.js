...
if(weapon&&weapon.Length>0){weapon_script.WeaponGive(weapon[Random.Range(0,weapon.Length)],false,0,0);}
...
if(temp_near_enemy){
if(weapon_script.weapon_index==0&&weapon_script.weapon.Count>1){weapon_script.WeaponSelect(1);return false;}
fire=true;
