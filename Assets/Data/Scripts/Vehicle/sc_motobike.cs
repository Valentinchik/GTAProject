...
public class sc_motobike : MonoBehaviour
{
	...
	public float suspensionDistance = 0.1f; // amount of movement in suspension
	...
	public float wheelRadius = 0.1f; // the radius of the wheels
	public float torque = 70f; // the base power of the engine (per wheel, and before gears)
	public float shiftTorque = 150f;
	[HideInInspector]
	public float curTorque = 100f;
	public float brakeTorque = 500f; // the power of the braks (per wheel)
	...
	public float maxSteerAngle = 35.0f; // max angle of steering wheels
	...
	public float[] gears = { -5f, 9f, 4f, 3f, 2f};
